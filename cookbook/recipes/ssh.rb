...
repos = {}
if node['github_manager']['ssh_databag'] && node['github_manager']['ssh_databag_item']
  repos['github_manager'] = {
    'ssh_databag' => node['github_manager']['ssh_databag'],
    'ssh_databag_item' => node['github_manager']['ssh_databag_item'],
  }
end
...
repos.each do |repo_name, attrs|
  ssh_data_bag = GithubManager::Helpers.load_data_bag(
    attrs['ssh_databag'],
  ...
  if ssh_data_bag && ssh_data_bag['private_key']
    ...
    ssh_dir = "/home/#{node['github_manager']['user']}/.ssh"
...
if node['github_manager']['github_host_key']
  ssh_known_hosts_entry 'github.com' do
    key node['github_manager']['github_host_key']
  end
end
